...
test_folder_path = 'C:/Users/pym12/Downloads/ML/loud_dataset/test_images'
...
# load the my trained YOLOv8n models
model_DET_nano = YOLO(my_trained_model_DET_nano_path)
model_SEG_nano = YOLO(my_trained_model_SEG_nano_path)
model_DET_small = YOLO(my_trained_model_DET_small_path)
model_SEG_small = YOLO(my_trained_model_SEG_small_path)
